...
public class Homework2 extends DBTest {
    ...
    void selectAllArtistsWithMoreThanOneAlbum(){
        List<Map<String, Object>> results = executeSQL("select artists.Name from artists join albums on artists.ArtistId = albums.ArtistId group by artists.ArtistId having count(albums.ArtistId) > 1");
    ...
    void selectTheTrackAndAlbumAndArtistForAllTracksLongerThanSixMinutes() {
        List<Map<String, Object>> results = executeSQL(
                "select artists.Name as Composer, tracks.name as Song, albums.Title as Album,tracks.Milliseconds as Time\n" +
                        "from tracks\n" +
